...
//Function to sort stocks by prices low to high
function sortStocksByPriceLowtoHigh(stock1, stock2) {
  return stock1.price - stock2.price;
}

//Function to sort stocks by prices high to low
function sortStocksByPriceHightoLow(stock1, stock2) {
...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    sortedStocks.sort(sortStocksByPriceLowtoHigh);
  } else {
    sortedStocks.sort(sortStocksByPriceHightoLow);
  }

  res.json({ stocks: sortedStocks });
});

//Function to sort stocks by growth low to high
function sortStocksByGrowthLowtoHigh(stock1, stock2) {
  return stock1.growth - stock2.growth;
}

//Function to sort stocks by growth high to low
function sortStocksByGrowthHightoLow(stock1, stock2) {
...
app.get('/stocks/sort/growth', (req, res) => {
  ...
  if (growth === 'low-to-high') {
    sortedStocks.sort(sortStocksByGrowthLowtoHigh);
  } else {
    sortedStocks.sort(sortStocksByGrowthHightoLow);
  }
